...
root_path = rootutils.setup_root(__file__, indicator=".project-root-yolo26", pythonpath=True, cwd=True)
...
OpenSeedDatasets: TypeAlias = Literal[
    "cfg/datasets/OpenSeed-LZU-detect.yaml",
    "cfg/datasets/OpenSeed-LZU-seg.yaml",
    "cfg/datasets/OpenSeed-LZU-detect-world.yaml",
    "cfg/datasets/OpenSeed-LZU-seg-world.yaml",
]
...
MODEL_WEIGHTS = {
    ...
    # YOLO 26
    "yolo26n.yaml": "weights/yolo26n.pt",
    "yolo26s.yaml": "weights/yolo26s.pt",
    "yolo26m.yaml": "weights/yolo26m.pt",
    "yolo26l.yaml": "weights/yolo26l.pt",
    "yolo26x.yaml": "weights/yolo26x.pt",
}
...
class OpenSeedArgs(Tap):
    ...
    batch: int = 64
    imgsz: int = 640
    data: OpenSeedDatasets = (
        "cfg/datasets/OpenSeed-LZU-detect.yaml"  # "OpenSeed-LZU-detect.yaml", "OpenSeed-LZU-seg.yaml"
    )
    seed: int = 42
