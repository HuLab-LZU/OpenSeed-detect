...
MODEL_VARIANTS = [
    ...
    "yolo-master-l",
    "yolo-master-x",
    # trained and evaluated inside 3rd_party/yolov26
    # "yolo26n",
    # "yolo26s",
    # "yolo26m",
    # "yolo26l",
    # "yolo26x",
    # trained and evaluated inside 3rd_party/RT-DERTv4
    # "rt-detrv4-s",
    # "rt-detrv4-m",
    # "rt-detrv4-l",
    # "rt-detrv4-x",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="OpenSeed-LZU-detect.yaml")
